...
const FileView = Backbone.View.extend({
    ...
    _onModelEvent: function (event, model, collection, options) {
        console.log('🚀 ~ file: scripts.js ~ line 30 ~ event', event);
    },
    deleteFile: function () {
        this.model.destroy({
            success: function (response) {
                console.log('deleted', response.toJSON());
            },
    ...
    update: function (e) {
        ...
        this.model.save(null,{
            success: function (response) {
                console.log('updated', response.toJSON());
            },
            error: function (error) {
                console.log('error updating ', error.toJSON());
            }
        })
    },
    edit: function () {
...
const FilesView = Backbone.View.extend({
    ...
    render: function () {
        const self = this;
        this.$el.html('');
        this.model.toArray().forEach(function (file) {
